    ...
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">No vendor profile</h3>
          <p className="mt-1 text-sm text-gray-500">
            You haven't created a vendor profile yet. Create one to start offering services on the marketplace.
          </p>
          <div className="mt-6">
            <button
              type="button"
