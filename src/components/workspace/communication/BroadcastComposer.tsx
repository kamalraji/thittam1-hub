...
export function BroadcastComposer({ workspace, onSendBroadcast, isSending }: BroadcastComposerProps) {
  ...
  const roleOptions = [
    { value: WorkspaceRole.TEAM_LEAD, label: 'Team Leads', icon: '👑' },
    { value: WorkspaceRole.EVENT_COORDINATOR, label: 'Event Coordinators', icon: '📋' },
    { value: WorkspaceRole.VOLUNTEER_MANAGER, label: 'Volunteer Managers', icon: '👥' },
    { value: WorkspaceRole.TECHNICAL_SPECIALIST, label: 'Technical Specialists', icon: '⚙️' },
    { value: WorkspaceRole.MARKETING_LEAD, label: 'Marketing Leads', icon: '📢' },
    { value: WorkspaceRole.GENERAL_VOLUNTEER, label: 'General Volunteers', icon: '🙋' },
  ];
